          ...
          <Toolbar disableGutters sx={{ minHeight: 34, px: { xs: 1, sm: 2 } }}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                <Tooltip title="Facebook"><IconButton component="a" href="https://www.facebook.com/GhanaAirForce" size="small" sx={{ color: '#3b5998' }}><FacebookIcon fontSize="small" /></IconButton></Tooltip>
                <Tooltip title="Instagram"><IconButton component="a" href="https://www.instagram.com/GhanaAirForce" size="small" sx={{ color: '#d62976' }}><InstagramIcon fontSize="small" /></IconButton></Tooltip>
                <Tooltip title="Twitter"><IconButton component="a" href="https://twitter.com/GhanaAirForce" size="small" sx={{ color: '#1DA1F2' }}><TwitterIcon fontSize="small" /></IconButton></Tooltip>
                <Tooltip title="YouTube"><IconButton component="a" href="https://www.youtube.com/GhanaAirForce" size="small" sx={{ color: '#FF0000' }}><YoutubeIcon fontSize="small" /></IconButton></Tooltip>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, pl: 1 }}><LocationOnIcon fontSize="small" /><Typography variant="caption" sx={{ fontWeight: 600 }}>Burma Camp, Accra</Typography></Box>
              </Box>
            </Box>
          </Toolbar>
        </Container>
          ...
          <Toolbar disableGutters sx={{ position: 'relative', minHeight: 72 }}>
            <Box display="grid" gridTemplateColumns={{ xs: 'auto 1fr auto' }} alignItems="center" width="100%">
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Typography variant="h6" component="div" sx={{ color: '#ffffff', fontWeight: 700 }}>Ghana Air Force</Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
                <Box sx={{ display: { xs: 'none', sm: 'flex', lg: 'none' }, gap: 1.5, alignItems: 'center' }}>
                  ...
                  <Button color="inherit" onClick={(e) => { e.preventDefault(); handleAboutOpen(e); }} sx={{ textTransform: 'none', color: '#fff' }}>About</Button>
